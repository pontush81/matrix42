...
![Bilden visar "Skapa fil"-fönstret med val att bocka i rutan för "Rättelse av uppgifter".](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_3a0d2141.png)
Detta gör att extra fält för urval av anställda att ta med i filen kommer fram.
![Bilden visar urvalsmöjligheterna vid skapandet av en rättelsefil. ](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_4da3ae3c.png)
...
![Bilden visar ett exempel på bruttoskuld som uppstått för en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_d1a43a32.png)
...
![Bilden visar detaljinformation i arbetsgivardeklarationen på individnivå för en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_f087c618.png)
![Bilden visar utdrag från en anställds lönespecifikation.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_9721dae6.png)
![Bilden visar översikten för en anställd i arbetsgivardeklarationen på individnivå, där underlaget är kontrollmarkerat.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_75df074f.png)
...
![Bilden visar ett exempel på skapande av en extra lönekörning.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_8f4485b0.png)
...
![Bild](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_01bbee86.png)
...
![Bild visar översikten i arbetsgivardeklarationen.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_83a26e72.png)
![Bilden visar detaljinformationen för en anställd i arbetsgivardeklarationen.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_a3fc125f.png)
...
![Bilden fälten för att skapa fil med rättelse och urval på en anställd markerade.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_a1aff817.png)
...
![Bilden visar urvalen för att skapa en extra lönekörning.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_9ba26ce1.png)
Ta ut en ny Arbetsgivardeklaration på individnivå och skicka in rättelsen.
![Bilden visar urval för att skapa rättelsefil för arbetsgivardeklarationen med urval på en anställd.](images/hur-gor-jag-en-rattelse-av-ett-fel-i-tidigare-arbetsgivardeklarationer-agi-i-hrm-payroll_4a74ce1e.png)
