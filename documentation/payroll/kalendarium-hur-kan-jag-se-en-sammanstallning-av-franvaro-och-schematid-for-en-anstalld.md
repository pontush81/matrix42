...
Kalendarium
i sidomenyn.
![Bilden visar menyvalet för Kalendarium](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_8163bd12.png)
Du får då upp följande vy:
![Bilden visar översikten för Kalendarium med kolumner för varje månad.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_f9bada89.png)
...
![Bilden visar fältet Anställd med pilar på varje sida för att bläddra mellan anställda.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_74bfdec8.png)
Datumintervall
Ange det datumintervall du vill visa kalendern för. Klicka på
uppdateringsikonen
för att uppdatera vyn efter varje ändring av datum.
![Bilden visar fälten för datumurval.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_c558b0d8.png)
Visa schematid
Markera rutan
Visa schematid
...
![Bilden visar rutan "Visa schematid" som ör markerad.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_1662de92.png)
Filter
Med funktionen
Filter
kan du ange ett urval av anställda som du vill arbeta med i kalendariet.
![Bilden visar filter-symbolen till höger om fältet för anställda.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_0ca8223a.png)
...
![Bilden visar urvalsmöjligheterna för filterfunktionen; olika fält för urval.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_7241bdcb.png)
...
![Bilden visar muspekaren hovrande över en dag med frånvaro som visar detaljerna om frånvaron.](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_b445c905.png)
...
![Bild](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_6eae870b.png)
Klicka på
Dölj summering
...
![Biden visar fältet för visa summering som fälls ut när man klickat på "Visa summering".](images/kalendarium-hur-kan-jag-se-en-sammanstallning-av-franvaro-och-schematid-for-en-anstalld_0a00fd44.png)
