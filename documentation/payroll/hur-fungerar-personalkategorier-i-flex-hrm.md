# ⚙️Hur fungerar Personalkategorier i Flex HRM?
...
Personalkategori är en gruppering av anställda som du vill ska tillämpa samma beräkningsregler baserat på avtal och regelverk. Personalkategorierna möjliggör t.ex. avvikelser på lönearter som ska hanteras olika för olika grupper av anställda och styr beräkningar i LAS och Lönekompass.
...
![Bild](images/hur-fungerar-personalkategorier-i-flex-hrm_385510a8.png)
...
![Bild](images/hur-fungerar-personalkategorier-i-flex-hrm_c7ab7856.png)
...
![Bild](images/hur-fungerar-personalkategorier-i-flex-hrm_fad7c4ac.png)
LAS
...
![Bild](images/hur-fungerar-personalkategorier-i-flex-hrm_f8b0b784.png)
Lönekompass
På personalkategorin anges den faktor för timlön som används för uträkning av heltidslön i Flex HRMs lönekompass. Standardvärdet är satt till 173. Du kan justera timlönsfaktor per personalkategori för att passa era kollektivavtal genom att ändra värdet och spara.
![Bild](images/hur-fungerar-personalkategorier-i-flex-hrm_7183a709.png)
