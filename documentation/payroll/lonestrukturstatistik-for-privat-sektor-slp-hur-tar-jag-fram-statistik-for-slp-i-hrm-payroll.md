...
.
![Bilden visar översikt av ett underlag för lönestrukturstatistiken.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_d7ffcaf6.png)
Skapa underlag
...
Ny
i knappraden.
![Knappen Ny visas markerad.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_36dce047.png)
...
![Bilden visar ruta med urvalsmöjligheter vis skapande av nytt underlag för lönestrukturstatistik.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_3e240e6c.png)
...
Preliminär
i vyn.
![Bilden visar fältet status där status visas som "Preliminär".](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_6a0b436c.png)
Ta bort underlag
...
![Bilden visar Ta bort-knappen.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_e486338e.png)
...
![Bilden visar fälten för redovisningsperiod och fältet där man se tför vilken statistik uppgifterna ska skickas till.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_efa0700e.png)
...
![Bilden visar översikten av ett underlag där man ser olika kolumner för olika värden.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_81bdaaea.png)
Du kan också exportera underlaget till Excel genom att klicka på knappen
Excel
i knappraden.
![Bilden visar knappen för att exportera underlaget till Excel..](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_c0816be7.png)
När underlaget är granskat markerar du underlaget som kontrollerat genom att klicka på knappen
Markera som kontrollerad
.
![Bilden visar knappen "Markera som kontrollerad".](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_4056c9bc.png)
...
Visa filer
i knappraden.
![Bilden visar knappen för att visa filer.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_9694260e.png)
...
![Bilden visar listan över skapade underlag med filer.](images/lonestrukturstatistik-for-privat-sektor-slp-hur-tar-jag-fram-statistik-for-slp-i-hrm-payroll_e5b47ea2.png)
Relaterade artiklar:
Hur beräknas underlaget för lönestrukturstatistik för privat sektor (SLP)?
