...
Artikeln ger dig information om granskningsnivåer i systemet och beskriver olika nivåer och anpassningar av flöden för till exempel tidrapporter och reseräkningar.
Allmänt - Granskningsnivåer
Under
Administration > Allmänt > Granskningsnivåer
specificeras vilka granskningsnivåer som kan användas i systemet. Upplägg av en granskningsnivå medför alltså inte automatiskt att denna granskningsnivå kommer att användas för respektive företag.
Följande undermenyer finns (beroende på licens):
Reseräkningar
Tidrapporter
Frånvaroansökningar
Lönerevision
...
För varje granskningsnivå får du ange om den valda granskningsnivån ska användas eller inte i företaget, samt ange hur den ska användas för varje nivå - till exempel om en viss nivå ska ha krav av en tidigare nivå eller inte. Du får också ange olika inställningar, beroende på vilken licens du har, för hur granskningsnivåerna ska fungera i det aktuella företaget.
